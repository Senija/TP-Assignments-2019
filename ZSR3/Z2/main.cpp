...
class Poligon : public GrafickiElement
{
    ...
    double *x, *y;
public:
    Poligon(GrafickiElement::Boje boja, int broj_tjemena) : GrafickiElement(boja), broj_tjemena(broj_tjemena), x(new double[broj_tjemena]), y(new double[broj_tjemena]) {}   void PostaviTjeme(int redni_broj, double x, double y)
    {
