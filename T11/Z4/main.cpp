...
public:
    ...
    //     izlazni_tok.write(reinterpret_cast< char *> this, sizeof *this); //pise u datoteku cout ofstream
    //     if(!izlazni_tok.write(reinterpret_cast< char *> timovi, broj_timova * sizeof(Tim) ))
    ...
    //     if (broj_timova +1 == kapaciteti) throw std::range_error ("Timovi popunjeni");
    //     char ime_tima1[20];
    ...
    //         char znak;
    //         ulazni_tok>>golovi_tim1>>znak>>golovi_tim2;
    //         timovi[broj_timova] = new Tim(ime_tima1);
    //         timovi[broj_timova]->ObradiUtakmicu(golovi_tim1, golovi_tim2);
    //         broj_timova++;
    //         timovi[broj_timova] = new Tim(ime_tima2);
    //         timovi[broj_timova]->ObradiUtakmicu(golovi_tim2, golovi_tim1);
    //         broj_timova
